...
path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model", "encoder.pkl") # TODO: enter the path for the saved encoder
...
# TODO: crete a GET on the root giving a welcome message
@app.get("/")
async def get_root():
    """ Say hello!"""
